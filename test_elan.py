...
class Elan(unittest.TestCase):
    ...
    def test_get_child_tiers_for(self):
    ...
    def test_get_ref_annotation_data_between_times(self):
        ...
        self.eaf.add_ref_annotation('a1', 'p1', 500, 'ref1')
        self.eaf.add_ref_annotation('a1', 'p1', 3000, 'ref2')
        self.assertEqual(sorted(self.eaf.get_ref_annotation_data_between_times(
            'a1', 500, 3500)), sorted([
                (0, 1000, 'ref1', 'a1'), (3000, 4000, 'ref2', 'a3')]))
        self.assertRaises(KeyError,
                          self.eaf.get_ref_annotation_data_between_times,
                          'eau', 0, 1)
    ...
    def test_remove_ref_annotation(self):
        self.eaf.add_tier('p1')
        self.eaf.add_linguistic_type('c', 'Symbolic_Association')
        self.eaf.add_tier('a1', 'c', 'p1')
        self.eaf.add_annotation('p1', 0, 1000, 'a1')
        ...
        self.assertEqual(
            sorted([(3000, 4000, '', 'a3'), (0, 1000, 'ref1', 'a1')]),
            sorted(self.eaf.get_ref_annotation_data_for_tier('a1')))
        self.eaf.remove_ref_annotation('a1', 500)
        self.assertEqual(
            sorted([(3000, 4000, '', 'a3')]),
            sorted(self.eaf.get_ref_annotation_data_for_tier('a1')))
        self.assertRaises(KeyError, self.eaf.remove_ref_annotation, 'aa', 0)
